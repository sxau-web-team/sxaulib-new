...
<form action="register.php" method="post" class="uk-form uk-form-stacked">
	<p>姓： <input type="text" name="first_name" size="15" maxlength="20" value="<?php if (isset($_POST['first_name'])) echo $_POST['first_name']; ?>" /></p>
	<p>名： <input type="text" name="last_name" size="15" maxlength="40" value="<?php if (isset($_POST['last_name'])) echo $_POST['last_name']; ?>" /></p>
	<p>邮箱： <input type="text" name="email" size="20" maxlength="60" value="<?php if (isset($_POST['email'])) echo $_POST['email']; ?>"  /> </p>
	...
	<p><button class="uk-button uk-button-primary"  name="submit" value="Register" />添加</button></p>
</form>
</div>
</div>
